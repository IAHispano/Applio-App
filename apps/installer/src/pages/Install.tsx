        ...
        <main className="min-h-screen min-w-screen overflow-hidden">
            <div className="w-full h-[100svh] overflow-hidden">
                ...
                <div className="w-full h-full flex flex-col justify-center items-center">
                    <h1 className="text-3xl text-white title font-semibold">Successfully installed!</h1>
                    <h2 className="text-neutral-300 max-w-sm text-sm text-balance text-center">You can now close this window and start using Applio App.</h2>
                </div>
                )}
                <div className="flex flex-col justify-end items-end p-4 h-full">
                    {error && (
                    <motion.div initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 0.2}} className="h-fit flex flex-col justify-end items-start gap-4 w-full pt-16 px-8">
                        <div className="bg-red-500/20 backdrop-filter backdrop-blur-3xl border border-white/10 w-full p-4 rounded-lg">
                        <h2 className="text-neutral-300 font-semibold title text-sm">Error detected</h2>
                        <h3 className="text-neutral-400 text-xs">We encountered an error during the installation process. Please try again later.</h3>
                        </div>
                    </motion.div>
                    )}
                    <div className="h-fit flex flex-col justify-end items-start gap-4 w-full pb-16 px-10 pt-4">
                        <h2 className="text-neutral-200 text-2xl font-semibold title">Installation Progress <span className="text-neutral-400 text-sm font-sans">({Math.round(value)}%)</span></h2>
                        <div className="w-full bg-neutral-700/60 rounded-lg overflow-hidden border border-white/10">
                            <div className="bg-neutral-300 h-2 rounded-lg" style={{ width: `${value}%` }} />
                        </div>
                    </div>
                </div>
            </div>
