    ...
    return (
      <header className="max-w-[25svh] w-fit h-full bg-[#111111]/50 border-r border-white/10 z-[200]">
          <div className="flex flex-col gap-4 justify-start items-end ml-auto p-4 h-full">
            <Link className="text-xl flex gap-4 w-full ml-auto items-center justify-end" to="/">
              ...
              <svg className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="246" height="277" viewBox="0 0 246 277" fill="none">
            ...
            <Link className="text-xl flex gap-4 w-full ml-auto items-center justify-end" to="/models">
            ...
            <Link className="text-xl flex gap-4 w-full ml-auto items-center justify-end" to="/convert">
              <span className={`h-12 w-12 flex items-center justify-center m-auto rounded-xl border-white/20 border hover:bg-white/10 slow ${isConverting ? 'shadow-xl shadow-green-500/40' : ''}`}>          
              {isConverting && <motion.div className="shadow-xl shadow-green-500/40" animate={{opacity: 1}} initial={{opacity: 0}} transition={{duration: 6}}/>}
              <svg className="w-6 h-6" fill="white" preserveAspectRatio="xMidYMid meet" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link className="text-xl flex gap-4 w-full ml-auto mt-auto " to="/settings">
